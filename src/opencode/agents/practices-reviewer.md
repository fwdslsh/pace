---
description: "Reviews code while incorporating lessons from past reviews and identifying new patterns to document. Use to ensure code follows established patterns and to capture learnings."
mode: subagent
tools:
  read: true
  grep: true
