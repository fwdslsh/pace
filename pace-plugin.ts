    ...
    config: async (opencodeConfig) => {
      ...
      if (isCommandEnabled(config, 'pace-init')) {
        opencodeConfig.command['pace-init'] = {
          ...
          agent:
            getCommandAgent(config, 'pace-init') ||
            paceInit.frontmatter.agent ||
            'pace-initializer',
      ...
      if (isCommandEnabled(config, 'pace-next')) {
        opencodeConfig.command['pace-next'] = {
          ...
          agent:
            getCommandAgent(config, 'pace-next') || paceNext.frontmatter.agent || 'pace-coding',
      ...
      if (isCommandEnabled(config, 'pace-continue')) {
        opencodeConfig.command['pace-continue'] = {
          ...
          agent:
            getCommandAgent(config, 'pace-continue') ||
            paceContinue.frontmatter.agent ||
            'pace-coding',
      ...
      if (isCommandEnabled(config, 'pace-coordinate')) {
        opencodeConfig.command['pace-coordinate'] = {
          ...
          agent:
            getCommandAgent(config, 'pace-coordinate') ||
            paceCoordinate.frontmatter.agent ||
            'pace-coordinator',
      ...
      if (isCommandEnabled(config, 'pace-review')) {
        opencodeConfig.command['pace-review'] = {
          ...
          agent:
            getCommandAgent(config, 'pace-review') ||
            paceReview.frontmatter.agent ||
            'pace-code-reviewer',
      ...
      if (isCommandEnabled(config, 'pace-compound')) {
        opencodeConfig.command['pace-compound'] = {
          ...
          agent:
            getCommandAgent(config, 'pace-compound') ||
            paceCompound.frontmatter.agent ||
